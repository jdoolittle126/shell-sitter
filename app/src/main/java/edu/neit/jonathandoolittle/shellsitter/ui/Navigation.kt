...
import edu.neit.jonathandoolittle.shellsitter.domain.models.ArticleModel
import edu.neit.jonathandoolittle.shellsitter.domain.models.PetModel
import edu.neit.jonathandoolittle.shellsitter.ui.menus.AnimatedNavigationItem
...
import edu.neit.jonathandoolittle.shellsitter.ui.util.LegacyReadingCard
...
fun ShellSitterModelRender(
    ...
    when(model) {
        is ArticleModel -> {
            LegacyReadingCard(title = model.title, markerColor = model.markerColor, contentPreview = model.preview)
        }
        is PetModel -> {
